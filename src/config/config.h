...
#define ADHOC_DECK_QUIC_RX_TASK_NAME "ADHOC_QUIC_RX"
#define ADHOC_DECK_QUIC_TX_TASK_NAME "ADHOC_QUIC_TX"
#define ADHOC_DECK_QUIC_TIMER_CLEAN_UP_TASK_NAME "ADHOC_QUIC_TIMER_CLEAN_UP"
